...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if (temperature * neutrons_produced_per_second) < 0.9 * threshold:
        return "LOW"
    elif ((temperature * neutrons_produced_per_second) >= (0.9 * threshold) and (temperature * neutrons_produced_per_second) <= 1.0 * threshold) or  ((temperature * neutrons_produced_per_second) >= (1.0 * threshold) and (temperature * neutrons_produced_per_second) <= (1.10 * threshold)):
        return "NORMAL"
    else:
        return "DANGER"