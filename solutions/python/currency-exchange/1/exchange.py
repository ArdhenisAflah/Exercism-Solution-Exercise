...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_money1 = exchange_money(budget, float(exchange_rate + spread))
    leftofver = get_leftover_of_bills(exchange_money1, denomination)
    return int(exchange_money1 - leftofver)
